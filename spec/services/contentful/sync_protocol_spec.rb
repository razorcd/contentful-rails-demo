...
RSpec.describe Contentful::SyncProtocol do
  ...
  context "#each_items_batch" do
    ...
    it "should follow 'nextPageUrl' url from response" do
      allow_any_instance_of(Contentful::SyncUrl::Singleton).to receive(:get).and_return("http://www.example1.com")
      allow_any_instance_of(Contentful::SyncUrl::Singleton).to receive(:set_next).with("http://www.example1.com")
